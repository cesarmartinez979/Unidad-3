...
def abrir_reportes():
   ...
   try:
      ...
      with open(archivo_path, "r", encoding="utf-8") as archivo_v:
         for linea in archivo_v:
            if linea.strip():
...
def abrir_acerca_de():
   texto = (
        ...
        "Proyecto Escolar – CBTis 89\n"
        "Programación 3°B\n"
        "\n"
        "Desarrollado por:\n"
        "César Armando Martínez Covarrubias\n"
        "\n"
        "Este sistema fue creado con el objetivo de ofrecer una "
        "herramienta funcional y sencilla para el registro de productos, "
        "gestión de ventas, generación de tickets y visualización de reportes.\n"
        "\n"
        "El proyecto aplica conocimientos de programación en Python, "
        "interfaces gráficas con Tkinter y manipulación de archivos.\n"
        "\n"
        "Con este módulo se concluye la elaboración del proyecto.\n"
        "--------------------------------------\n"
        "Versión 1.0"
    )
